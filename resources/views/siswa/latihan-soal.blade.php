    ...
    <div class="row g-3">
        ...
        <div class="col-lg-8">
            ...
            <div style="background:linear-gradient(135deg,#1e3a5f,#2d5282);border-radius:16px;padding:20px 24px;color:#fff;margin-bottom:20px;display:flex;align-items:center;justify-content:space-between;">
                ...
                <div style="background:rgba(255,255,255,.15);border-radius:10px;padding:8px 16px;text-align:center;min-width:80px;">
            ...
            <div class="soal-item" id="soal-{{ $index }}"
                ...
                <div style="font-size:11px;font-weight:700;color:#1e3a5f;text-transform:uppercase;margin-bottom:10px;">
            ...
            <div style="text-align:center;padding:40px;background:#fff;border-radius:16px;">
                ...
                <div style="font-size:15px;font-weight:600;margin-top:12px;color:#64748b;">Belum ada soal untuk materi ini</div>
        ...
        <div class="col-lg-4">
            <div style="background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:20px;position:sticky;top:20px;">
                ...
                <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:6px;margin-bottom:16px;">
                    ...
                    <button type="button" class="nomor-btn {{ $index === 0 ? 'current' : '' }}"
                        id="nomor-{{ $index }}"
                        onclick="gotoSoal(soalAktif, {{ $index }})">
                        {{ $index + 1 }}
                    </button>
                    @endforeach
                </div>
                ...
                <div style="font-size:11px;color:#64748b;margin-bottom:16px;">
                    <span class="me-3">
                        <span style="display:inline-block;width:10px;height:10px;background:#1e3a5f;border-radius:3px;"></span>
                        Aktif
                    </span>
                    <span class="me-3">
                        <span style="display:inline-block;width:10px;height:10px;background:#16a34a;border-radius:3px;"></span>
                        Dijawab
                    </span>
                    <span>
                        <span style="display:inline-block;width:10px;height:10px;background:#e2e8f0;border-radius:3px;border:1px solid #cbd5e1;"></span>
                        Belum
                    </span>
                </div>
                ...
                <div style="background:#f8faff;border-radius:10px;padding:12px;margin-bottom:16px;">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-center">
                            <div style="font-size:18px;font-weight:800;color:#94a3b8;" id="stat-belum">{{ count($soal) }}</div>
                            <div style="font-size:10px;color:#64748b;">Belum</div>
                        </div>
                        <div class="text-center">
                            <div style="font-size:18px;font-weight:800;color:#1e3a5f;" id="stat-total">{{ count($soal) }}</div>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:380px;">
        <div class="modal-content" style="border-radius:16px;border:none;">
            <div class="modal-body text-center p-4">
                <div style="width:60px;height:60px;border-radius:50%;background:#dcfce7;display:flex;align-items:center;justify-content:center;font-size:1.6rem;color:#16a34a;margin:0 auto 16px;">
                ...
                <p style="font-size:.84rem;color:#64748b;margin-bottom:4px;">
                    Kamu sudah menjawab <strong id="modal-dijawab">0</strong> dari <strong>{{ count($soal) }}</strong> soal.
                </p>
                <p style="font-size:.8rem;color:#94a3b8;margin-bottom:20px;">Jawaban tidak bisa diubah setelah dikumpulkan.</p>
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn rounded-2 fw-semibold flex-fill"
                        style="background:#16a34a;color:#fff;border:none;font-size:.85rem;"
