...
<style>
    ...
    .form-control-custom.select{cursor:pointer;}

    /* ── ACHIEVEMENT ── */
    .achieve-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;}
    .achieve-card{background:var(--bg);border-radius:12px;padding:14px;text-align:center;transition:transform .2s;}
    .achieve-card:hover{transform:translateY(-2px);}
    .achieve-card.unlocked{background:linear-gradient(135deg,var(--accent-soft),#fffbeb);border:1px solid var(--accent);}
    .achieve-card.locked{opacity:.45;filter:grayscale(1);}
    .achieve-icon{font-size:28px;margin-bottom:6px;}
    .achieve-title{font-size:11.5px;font-weight:700;color:var(--text);}
    .achieve-sub{font-size:10px;color:var(--muted);margin-top:2px;}

    /* ── PAKET CARD ── */
    .paket-aktif{background:linear-gradient(135deg,var(--primary),var(--primary-light));border-radius:16px;padding:20px;color:#fff;margin-bottom:16px;}
    .pa-label{font-size:11px;opacity:.7;margin-bottom:4px;}
    .pa-name{font-size:20px;font-weight:800;margin-bottom:4px;}
    .pa-period{font-size:12px;opacity:.7;}
    .pa-features{margin-top:12px;display:flex;flex-direction:column;gap:5px;}
    .pa-feature{font-size:12px;opacity:.85;display:flex;align-items:center;gap:6px;}

    /* ── DANGER ZONE ── */
    .danger-zone{background:var(--danger-soft);border:1.5px solid var(--danger);border-radius:16px;padding:20px;}
    .dz-title{font-size:14px;font-weight:700;color:var(--danger);margin-bottom:8px;}
    .dz-desc{font-size:12.5px;color:#7f1d1d;margin-bottom:14px;line-height:1.5;}
...
<div class="profile-header">
    ...
    <div class="profile-stats">
        <div class="ps-item"><div class="ps-val">87</div><div class="ps-label">Rata-rata Nilai</div></div>
        <div class="ps-item"><div class="ps-val">42</div><div class="ps-label">Soal Selesai</div></div>
        <div class="ps-item"><div class="ps-val">8</div><div class="ps-label">Sesi Les</div></div>
        <div class="ps-item"><div class="ps-val">5</div><div class="ps-label">Badge</div></div>
    </div>
</div>
        ...
        <div class="d-flex flex-column gap-3">
            ...
            <div class="d-flex align-items-center justify-content-between p-3 rounded-3" style="background:var(--bg);">
                ...
                <div class="form-check form-switch mb-0">
                    <input class="form-check-input" type="checkbox" {{ $ns[2] ? 'checked' : '' }} style="width:40px;height:22px;cursor:pointer;"/>
                </div>
            </div>
            @endforeach
        </div>
