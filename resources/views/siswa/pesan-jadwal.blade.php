            ...
            <div class="tutor-grid" id="tutorGrid">
                ...
                @foreach ($tutors as $idx => $t)
                    <div class="tutor-card" onclick="selectTutor(this, {{ $idx }})"
                        data-name="{{ $t[3] }}" data-mapel="{{ $t[4] }}" data-harga="{{ $t[9] }}"
                        data-mode="{{ $t[7] }}">
                        <div class="tutor-avatar" style="background:{{ $t[1] }};color:#fff;">{{ $t[0] }}
                        </div>
                        ...
                        <div class="tutor-badge"
                            style="background:{{ str_contains($t[7], 'Online & Offline') ? 'var(--success-soft)' : 'var(--info-soft)' }};color:{{ str_contains($t[7], 'Online & Offline') ? 'var(--success)' : 'var(--info)' }};">
                            {{ $t[7] }}
                        </div>
