...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .s-blue .stat-val { color: #1e3a5f; }
        .s-green { background: #dcfce7; }
        .s-green .stat-val { color: #16a34a; }
        .s-yellow { background: #fef9c3; }
        .s-yellow .stat-val { color: #d97706; }
        .s-red { background: #fee2e2; }
        ...
        .b-primary { background: #eff6ff; color: #1e3a5f; }

        /* ── PROGRES BAR ── */
        .bar-wrap { width: 80px; height: 8px; background: #e2e8f0; border-radius: 4px; display: inline-block; vertical-align: middle; }
...
<div class="tbl-wrap">
    <table>
        ...
        @empty
        <tr>
            <td colspan="8" style="text-align:center;color:#94a3b8;padding:20px;">Belum ada data latihan</td>
        </tr>
        @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <div class="bar-wrap" style="margin-left:6px;">
                    <div class="bar-fill" style="width:{{ $avg }}%;background:{{ $bar }};"></div>
                </div>
            </td>
            <td style="color:#16a34a;font-weight:bold;">{{ $max }}</td>
            <td style="color:#dc2626;font-weight:bold;">{{ $min }}</td>
            <td>
                <span class="badge {{ $avg >= 80 ? 'b-success' : ($avg >= 60 ? 'b-warning' : 'b-danger') }}">
