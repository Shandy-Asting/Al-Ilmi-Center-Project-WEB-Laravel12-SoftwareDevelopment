...
<div class="filter-tabs">
    <div class="filter-tab active">Semua <span style="background:var(--danger);color:#fff;border-radius:20px;font-size:10px;padding:1px 6px;margin-left:4px;">4</span></div>
...
<div class="card-box mb-3">
    ...
    <div class="notif-item unread">
        ...
        <div style="flex-shrink:0;display:flex;flex-direction:column;align-items:flex-end;gap:6px;">
            ...
            <a href="/tutor/les-privat" class="btn-notif" style="background:var(--primary);color:#fff;">Lihat Pesanan</a>
        </div>
    </div>
