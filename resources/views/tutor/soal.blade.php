...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        <div>
            ...
            <p style="font-size:.85rem;color:var(--muted);margin:0;">Buat, kelola, dan atur soal latihan serta kuis untuk
                siswa Anda.</p>
        </div>
            ...
            <table class="table-soal">
                ...
                <tbody>
                    @php
                        $soals = [
                            [
                                'Tentukan nilai dari sin 30° + cos 60° – tan 45°. Nyatakan hasilnya dalam bentuk pecahan paling sederhana.',
                                'Trigonometri',
                                '3 Apr 2026',
                                'SMA',
                                '#dbeafe',
                            ...
                            [
                                'Sebuah bola dilempar horizontal dari ketinggian 20 m dengan kecepatan awal 10 m/s. Berapa jarak horizontal yang ditempuh?',
                                'Gerak Parabola',
                                '3 Apr 2026',
                                'SMA',
                                '#dbeafe',
                            ...
                            [
                                'Jelaskan perbedaan antara reaksi eksoterm dan endoterm. Berikan masing-masing dua contoh dalam kehidupan sehari-hari!',
                                'Termokimia',
                                '1 Apr 2026',
                                'SMA',
                                '#dbeafe',
                            ...
                            [
                                'Pernyataan berikut benar atau salah: "Gaya aksi dan reaksi bekerja pada benda yang sama."',
                                'Hukum Newton',
                                '4 Apr 2026',
                                'SMA',
                                '#dbeafe',
                            ...
                            [
                                'Diketahui deret aritmetika dengan suku pertama 3 dan beda 5. Tentukan suku ke-20!',
                                'Barisan & Deret',
                                '2 Apr 2026',
                                'SMP',
                                '#f0fdf4',
                            ...
                            [
                                'Rearrange the words: "always / she / early / comes / to / school"',
                                'Grammar',
                                '28 Mar 2026',
                                'SMP',
                                '#f0fdf4',
                            ...
                            [
                                'Berapa massa 2 mol air (H₂O)? (Ar H = 1, Ar O = 16)',
                                'Stoikiometri',
                                '1 Apr 2026',
                                'SMA',
                                '#dbeafe',
                            ...
                            [
                                'Pernyataan berikut benar atau salah: "Sel eukariotik tidak memiliki membran inti."',
                                'Biologi Sel',
                                '30 Mar 2026',
                                'SMA',
                                '#dbeafe',
                            ...
                            [
                                'Uraikan langkah-langkah metode eliminasi untuk menyelesaikan SPLDV: 2x + 3y = 12 dan x – y = 1.',
                                'SPLDV',
                                '2 Apr 2026',
                                'SMP',
                                '#f0fdf4',
                    ...
                    @foreach ($soals as $i => $s)
                        <tr>
                            ...
                            <td><span class="badge-jenjang"
                                    style="background:{{ $s[4] }};color:{{ $s[5] }};">{{ $s[3] }}</span>
                            </td>
                            <td><span class="badge-mapel">{{ $s[6] }}</span></td>
                            <td><span
                                    class="badge-tipe-soal {{ $s[8] }}">{{ strtoupper($s[8]) === 'PG' ? 'Pil. Ganda' : ($s[8] === 'esai' ? 'Esai' : ($s[8] === 'bs' ? 'Benar/Salah' : 'Isian')) }}</span>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-1">
                                    <button class="btn-action suc" title="Lihat Detail" data-bs-toggle="modal"
                                        data-bs-target="#modalDetail"><i class="bi bi-eye"></i></button>
                                    <button class="btn-action" title="Edit" data-bs-toggle="modal"
                    ...
                    <div class="row g-3">
                        <div class="col-lg-8">
                            <div class="p-3 rounded-3 mb-3" style="background:var(--bg);border:1px solid var(--border);">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label class="form-label-custom">Jenjang <span
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label-custom">Mata Pelajaran <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control-custom">
                                            <option value="">-- Pilih --</option>
                                            <option>Matematika</option>
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label-custom">Tipe Soal <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control-custom">
                                            <option value="">-- Pilih --</option>
                                            <option>Pilihan Ganda</option>
                            ...
                            <div class="mb-3">
                                <label class="form-label-custom">Teks Pertanyaan <span
                                        class="text-danger">*</span></label>
                            ...
                            @foreach (['A', 'B', 'C', 'D'] as $opt)
                                <div class="option-row">
                                    <div class="option-label {{ $opt === 'A' ? 'correct' : '' }}">{{ $opt }}
                                    </div>
                                    <input type="text" class="option-input {{ $opt === 'A' ? 'correct-input' : '' }}"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="pembahasan-box">
                                    <div class="pembahasan-label"><i class="bi bi-lightbulb-fill"></i> Pembahasan Jawaban
                                    </div>
                                    <textarea class="form-control-custom" rows="3" style="background:transparent;border-color:#a7f3d0;"
                        ...
                        <div class="col-lg-4">
                            <div class="card-box p-3 mb-3">
                                <div
                                    style="font-size:.78rem;font-weight:700;color:var(--muted);text-transform:uppercase;margin-bottom:10px;">
                                    <i class="bi bi-gear me-1" style="color:var(--primary);"></i> Pengaturan
                                </div>
                                <div class="mb-3">
                                    <label class="form-label-custom">Waktu Pengerjaan</label>
                                    <div class="d-flex gap-2 align-items-center">
                                        <input type="number" class="form-control-custom" value="2"
                                            style="width:70px;" />
                                ...
                                <div class="form-check form-switch mt-2">
                                    ...
                                    <label class="form-check-label" style="font-size:.83rem;">Acak urutan opsi
                                        jawaban</label>
                                </div>
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" checked />
                                    <label class="form-check-label" style="font-size:.83rem;">Tampilkan pembahasan setelah
                                        kuis</label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <span class="ms-auto" style="font-size:.75rem;color:var(--muted);"><i
                                class="bi bi-folder2 me-1"></i>Trigonometri</span>
                    </div>
                    <div
                        style="background:var(--bg);border-radius:12px;padding:16px;border:1px solid var(--border);margin-bottom:16px;">
                        <div
                            style="font-size:.73rem;font-weight:700;color:var(--muted);text-transform:uppercase;margin-bottom:8px;">
                            Pertanyaan</div>
                        <div style="font-size:.9rem;font-weight:500;line-height:1.6;color:var(--text);">
                            Tentukan nilai dari <strong>sin 30° + cos 60° – tan 45°</strong>. Nyatakan hasilnya dalam bentuk
                    ...
                    <div class="mb-4">
                        ...
                        @foreach ($opts as $o)
                            <div
                                style="display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:9px;margin-bottom:6px;{{ $o[2] ? 'background:var(--success-soft);border:1px solid #a7f3d0;font-weight:600;color:#065f46;' : 'background:#fff;border:1px solid var(--border);color:var(--muted);' }}">
                                <div
                                    style="width:24px;height:24px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.72rem;font-weight:700;background:{{ $o[2] ? 'var(--success)' : 'var(--border)' }};color:{{ $o[2] ? '#fff' : 'var(--muted)' }};flex-shrink:0;">
                                    {{ $o[0] }}</div>
                                {{ $o[1] }}
                                @if ($o[2])
                                    <span class="ms-auto" style="font-size:.75rem;"><i
                                            class="bi bi-check-circle-fill text-success"></i> Jawaban Benar</span>
                                @endif
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn rounded-2 fw-semibold"
                        style="background:var(--warning);color:#fff;font-size:.85rem;border:none;" data-bs-toggle="modal"
                        data-bs-target="#modalEdit" data-bs-dismiss="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center gap-3 p-3 rounded-3 mb-4"
                        ...
                        <div>
                            <div style="font-weight:600;font-size:.86rem;color:var(--text);">Trigonometri – Pilihan Ganda
                            </div>
                            <div style="font-size:.73rem;color:var(--muted);">SMA · Matematika · Sedang · Digunakan di 3
                                kuis</div>
                        </div>
                    ...
                    @foreach ($editOpts as $o)
                        <div class="option-row">
                            ...
                            <input type="text" class="option-input {{ $o[2] ? 'correct-input' : '' }}"
                                value="{{ $o[1] }}" />
                            <button type="button" class="btn-action"><i class="bi bi-x"></i></button>
                        </div>
                    @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width:400px;">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    <div
                        style="width:64px;height:64px;border-radius:50%;background:var(--danger-soft);display:flex;align-items:center;justify-content:center;font-size:1.8rem;color:var(--danger);margin:0 auto 16px;">
                        <i class="bi bi-trash3-fill"></i>
                    </div>
                    <h5 style="font-weight:700;margin-bottom:8px;color:var(--text);">Hapus Soal?</h5>
                    <p style="font-size:.86rem;color:var(--muted);margin-bottom:4px;">Anda akan menghapus soal ini secara
                        permanen.</p>
                    <div class="p-3 rounded-3 mb-3 text-start"
                        style="background:var(--danger-soft);border:1px solid #fecaca;">
                        <div style="font-size:.78rem;color:var(--danger);font-weight:600;"><i
                                class="bi bi-exclamation-triangle-fill me-1"></i> Perhatian</div>
                        <div style="font-size:.77rem;color:#7f1d1d;margin-top:4px;">Soal ini digunakan di <strong>3 kuis
                                aktif</strong>. Menghapusnya akan otomatis menghapus dari semua kuis tersebut.</div>
                    </div>
                    <div class="d-flex gap-2">
                        <button class="btn rounded-2 fw-semibold flex-fill"
                            style="background:#f1f5f9;color:var(--muted);border:none;font-size:.85rem;"
                            data-bs-dismiss="modal">Batalkan</button>
                        <button class="btn rounded-2 fw-semibold flex-fill"
                            style="background:var(--danger);color:#fff;border:none;font-size:.85rem;"><i
                                class="bi bi-trash3 me-1"></i> Ya, Hapus</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade modal-custom" id="modalImport" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered" style="max-width:480px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:.84rem;color:var(--muted);margin-bottom:16px;">Upload file soal dalam format yang
                        didukung.</p>
                    ...
                    <div
                        style="border:2px dashed var(--border);border-radius:12px;padding:28px;text-align:center;background:var(--bg);cursor:pointer;transition:all .2s;">
                        <div style="font-size:2rem;color:var(--muted);margin-bottom:8px;"><i
                    ...
                    <div class="mt-3 p-3 rounded-3" style="background:#eff6ff;border:1px solid #bfdbfe;">
                        <div style="font-size:.78rem;font-weight:700;color:var(--primary);margin-bottom:4px;"><i
                                class="bi bi-info-circle me-1"></i>Panduan Format</div>
                        <div style="font-size:.75rem;color:#1e40af;">
                            Download <a href="#" style="color:var(--primary);font-weight:600;">template Excel</a>
                            atau <a href="#" style="color:var(--primary);font-weight:600;">template Word</a> untuk
                ...
                <div class="modal-footer">
                    <button class="btn rounded-2 fw-semibold"
                        ...
                        data-bs-dismiss="modal">Batal</button>
                    <button class="btn rounded-2 fw-semibold"
                        style="background:var(--primary);color:#fff;font-size:.85rem;border:none;"><i
                            class="bi bi-upload me-1"></i> Import Sekarang</button>
                </div>
            </div>
        </div>
    </div>
