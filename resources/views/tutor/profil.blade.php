...
@section('content')
    ...
    <div class="profile-header">
        ...
        <div class="profile-stats">
            ...
            <div>
                <div class="ps-val">48</div>
                <div class="ps-label">Ulasan</div>
            </div>
            <div>
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @endforeach
                        <span
                            style="background:var(--bg);color:var(--muted);font-size:12.5px;font-weight:700;padding:5px 14px;border-radius:20px;cursor:pointer;border:1.5px dashed var(--border);">
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        @foreach (['SMP', 'SMA', 'Perguruan Tinggi'] as $j)
                            <span
                                style="background:{{ in_array($j, ['SMP', 'SMA']) ? 'var(--success)' : 'var(--bg)' }};color:{{ in_array($j, ['SMP', 'SMA']) ? '#fff' : 'var(--muted)' }};font-size:12px;font-weight:700;padding:5px 12px;border-radius:20px;cursor:pointer;border:1.5px solid {{ in_array($j, ['SMP', 'SMA']) ? 'var(--success)' : 'var(--border)' }};">
                                {{ $j }}
                            </span>
                        @endforeach
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div style="position:relative;">
                        <span
                            style="position:absolute;left:14px;top:50%;transform:translateY(-50%);font-weight:700;color:var(--muted);">Rp</span>
    ...
    <div id="section-ulasan" style="display:none;">
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                <div
                    style="background:var(--card-bg);border:1px solid var(--border);border-radius:16px;padding:24px;text-align:center;">
                    ...
                    <div style="margin-top:14px;">
                        @foreach ([[5, 75], [4, 18], [3, 5], [2, 1], [1, 1]] as $r)
                            <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                                <span
                                    style="font-size:11px;font-weight:700;width:14px;text-align:right;">{{ $r[0] }}</span>
                                <i class="bi bi-star-fill" style="font-size:10px;color:var(--accent);"></i>
                                <div
                                    style="flex:1;height:6px;border-radius:10px;background:var(--border);overflow:hidden;">
                                    <div
                                        style="height:100%;border-radius:10px;background:var(--accent);width:{{ $r[1] }}%;">
                                    </div>
                                </div>
                    ...
                    @php
                        $ulasans = [
                            [
                                ...
                                'Maya Putri',
                                5,
                                'Pak Budi sangat sabar dan penjelasannya mudah dipahami. Nilai Matematika saya naik dari 60 ke 85!',
                                '2 hari yang lalu',
                            ],
                            [
                                'A',
                                ...
                                'Aldi Pratama',
                                5,
                                'Materi UTBK Trigonometri jadi lebih jelas. Sangat recommended!',
                                '5 hari yang lalu',
                            ],
                            [
                                'S',
                                ...
                                'Sinta Dewi',
                                4,
                                'Penjelasan bagus, tapi kadang terlalu cepat untuk materi baru. Overall sangat membantu.',
                                '1 minggu yang lalu',
                            ],
                            [
                                'R',
                                ...
                                'Rizky Aditya',
                                5,
                                'Metode belajar Pak Budi berbeda dari guru sekolah, lebih ke pemahaman. Suka!',
                                '2 minggu yang lalu',
                            ],
                        ];
                    @endphp
                    @foreach ($ulasans as $u)
                        <div class="ulasan-item">
                            <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px;">
                                <div
                                    style="width:32px;height:32px;border-radius:50%;background:{{ $u[1] }};color:#fff;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;flex-shrink:0;">
                                    {{ $u[0] }}</div>
                                <div style="flex:1;">
                                    <div style="font-size:13px;font-weight:700;color:var(--text);">{{ $u[2] }}
                                    </div>
                                </div>
