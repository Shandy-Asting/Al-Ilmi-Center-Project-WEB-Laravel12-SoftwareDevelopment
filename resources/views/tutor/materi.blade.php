                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="materi-card">
                        ...
                        <div class="materi-card-body">
                            <div class="d-flex gap-1 mb-2 flex-wrap">
                                <span class="badge-jenjang"
                                    style="background:#dbeafe;color:#1d4ed8;">{{ $g[4] }}</span>
                        ...
                        <div class="materi-card-footer">
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn-action" data-bs-toggle="modal" data-bs-target="#modalUbah"><i
                                        class="bi bi-pencil"></i></button>
                                <button class="btn-action del" data-bs-toggle="modal" data-bs-target="#modalHapus"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center gap-3 p-3 rounded-3 mb-4"
                        ...
                        <div class="materi-icon-wrap" style="background:#fee2e2;"><i class="bi bi-file-earmark-pdf-fill"
                                style="color:var(--danger);"></i></div>
                        <div>
                            <div style="font-weight:600;font-size:.88rem;color:var(--text);">Trigonometri – Dasar dan
                                Penerapan</div>
                            <div style="font-size:.75rem;color:var(--muted);">PDF · SMA · Matematika · Terakhir diubah: 2
                                Apr 2026</div>
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control-custom"
                                value="Trigonometri – Dasar dan Penerapan" />
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <div class="upload-zone">
                                <div style="font-size:1.5rem;color:var(--muted);margin-bottom:6px;"><i
                                        class="bi bi-arrow-repeat"></i></div>
                                <div style="font-size:.82rem;color:var(--muted);">
                                    <strong style="color:var(--primary);">Upload file baru</strong> untuk mengganti<br />
                                    <span style="color:var(--success);">File saat ini: trigonometri_dasar.pdf (2.4
                                        MB)</span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width:400px;">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <p style="font-weight:600;font-size:.9rem;margin-bottom:16px;color:var(--text);">"Trigonometri – Dasar
                        dan Penerapan"</p>
