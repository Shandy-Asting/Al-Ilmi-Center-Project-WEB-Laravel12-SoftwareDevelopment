            ...
            <div class="card-box">
                <div class="mini-cal">
                    @php
                        ...
                        $eventDates = [
                            $currentDate->format('Y-m') . '-02',
                            $currentDate->format('Y-m') . '-03',
                            $currentDate->format('Y-m') . '-08',
                            $currentDate->format('Y-m') . '-11',
                            $currentDate->format('Y-m') . '-15',
                            $currentDate->format('Y-m') . '-16',
                            $currentDate->format('Y-m') . '-17',
                            $currentDate->format('Y-m') . '-22',
                ...
                @php
                    $progres = [
                        [
                            ...
                            '82',
                            'var(--primary)',
                            'Bab 8 dari 10 · Trigonometri selesai',
                        ],
                        ...
                        [
                            ...
                            '40',
                            'var(--danger)',
                            'Bab 4 dari 10 · Perlu perhatian ekstra',
                        ],
                    ];
                @endphp
                    ...
                    <div class="progress-item">
                        ...
                        <div class="progress">
                            <div class="progress-bar"
                                style="width:{{ $p[2] }}%;background:{{ $p[3] }};"></div>
                        </div>
