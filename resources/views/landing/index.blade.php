  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-nav-login {
      ...
      background: transparent; padding: 7px 16px; border-radius: 8px;
    ...
    .mobile-menu {
      ...
      padding: 16px 20px 20px; flex-direction: column; gap: 6px;
    }
    .mobile-menu.open { display: flex; }
    .mobile-menu .nav-link-custom { padding: 10px 12px; }
    .mobile-menu .btn-nav-login,
    .mobile-menu .btn-nav-daftar { text-align: center; padding: 10px; }
    ...
    .hero-title {
      color: #fff; font-size: 38px; font-weight: 800; line-height: 1.2; margin-bottom: 16px;
    }
    .hero-title span { color: var(--accent); }
    .hero-sub {
      color: rgba(255,255,255,.75); font-size: 15px; line-height: 1.7;
      margin-bottom: 28px;
    }
    ...
    .section-title { font-size: 28px; font-weight: 800; color: var(--primary); margin-bottom: 12px; }
    .section-sub   { font-size: 15px; color: var(--muted); line-height: 1.7; }

    /* ── FITUR CARDS ── */
    .feature-card {
      background: #fff; border: 1px solid var(--border); border-radius: 16px;
      padding: 24px; transition: all .2s; height: 100%;
    }
    ...
    .feature-title { font-size: 15px; font-weight: 700; color: var(--primary); margin-bottom: 8px; }
    ...
    .paket-price { font-size: 30px; font-weight: 800; margin: 12px 0 4px; }
    ...
    .paket-list li i { font-size: 14px; flex-shrink: 0; }
    .btn-paket {
    ...
    .cta-sub   { color: rgba(255,255,255,.7); font-size: 15px; margin-bottom: 28px; }
    ...
    .footer-desc  { color: rgba(255,255,255,.5); font-size: 13px; line-height: 1.7; }
    ...
    @media (max-width: 767.98px) {
      ...
      .btn-hero-primary,
      .btn-hero-outline { padding: 11px 18px; font-size: 13.5px; }
      ...
      .cta-section .btn-hero-outline { width: 100%; max-width: 320px; justify-content: center; }
